...
const animalsCountLetters = animals.map((animal) => animal.length);
console.log(animalsCountLetters);
...
const sumOddNumbers = numbers.filter((number) => number % 2).reduce((acc, oddNumber) => acc + oddNumber, 0);
