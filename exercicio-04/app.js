...
const my3FavoriteTVShows = ["Homem-Aranha", "Super-Man", "Iron-Man"];
const sentence = `Meus 3 filmes favoritas são: ${my3FavoriteTVShows.join(", ")}`.replace(", I", " e I");
...
const countCaracter = 39;
// console.log(
//   `A string que a "typeSentence" armazena tem mais de ${countCaracter} caracteres? ${String(
//     typeSentence.length > countCaracter
//   ).replace("t", "T")}`
// );
...
//Porque o null em uma operaão é 0 e a operação resultou no número 1
/*
