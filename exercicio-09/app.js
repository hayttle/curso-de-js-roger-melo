...
const stringAmount = (string) => string.length;

// console.log(stringAmount('teste'))
...
const stringToLower = (string) => string.toLowerCase();
...
const checkString = (char, string) => string.indexOf(char);

// console.log(checkString('a', 'coisa'))
...
const checkArray = (item = null, array = []) => array.includes(item);

// console.log(checkArray(2,[7,4,3,2]))
...
const showName = () => console.log("Hayttle");
...
*/
const invokeFunc = (value, callback) => {
  return callback(value);
};

const tripleNumber = (value) => value * 3;

// console.log(invokeFunc(25,tripleNumber));
...
//   console.log(`O ${index+1}º item do array [${array.join(', ')}] é ${number}.`);
// })
...
*/
const names = ["Maria", "João","Paulo","José","Oto"];

const likes = (names = []) => {
const firstName = names[0]
const secondName = names[1]
const thirdName = names[2]
const remainPeople = names.length-2
  ...
  switch (names.length) {
    ...
    default:
    return `${firstName}, ${secondName} e mais ${remainPeople} pessoas curtiram isso`
  }
};
