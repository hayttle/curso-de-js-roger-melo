...
const y = 12
const z = 18
const isMorning = hour >= x && hour < y
const isAfternoon = hour >= y && hour < z
...
if (isChild || isOlder) {
  entrance = "Para você, a entrada é grátis!";
} else {
  entrance = "A entrada é R$ 30,00.";
}
...
// console.log(`O crazyArray tem ${boolean} booleans, ${number} números e ${string} strings.`);
