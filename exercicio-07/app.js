...
console.log(`
  3 informações sobre o array randomValues:
    - As primeiras 4 strings são ${arrayString.join(", ").replace(`, ${lastItem}`, ` e ${lastItem}`)};
    - Até que as primeiras 4 strings fossem iteradas, ${countBoolean} booleans foram iterados;
